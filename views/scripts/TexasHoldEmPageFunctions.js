  ...
  var shuffle = function(){
		...
		$("#shuffle-button").toggle();
		$("#deal-button").toggle();
		$("#flop1").attr("src", "../views/images/b2fv.png");
		$("#flop2").attr("src", "../views/images/b2fv.png");
		$("#flop3").attr("src", "../views/images/b2fv.png");
		$("#turn").attr("src", "../views/images/b2fv.png");
		$("#river").attr("src", "../views/images/b2fv.png");
		$("#p1card1").attr("src", "../views/images/b2fv.png");
		$("#p1card2").attr("src", "../views/images/b2fv.png");
		$("#p2card1").attr("src", "../views/images/b2fv.png");
		$("#p2card2").attr("src", "../views/images/b2fv.png");
